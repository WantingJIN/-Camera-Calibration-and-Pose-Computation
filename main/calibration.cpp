...
int main()
{
    ...
    CBTracker tracker(8,5);     // this one is to be given the chessboard dimension (8x5)
    ...
    int a=patterns[0].im.rows;
    int b=patterns[0].im.cols;
    const double pxy = 0.5 * (a + b);

    PerspectiveCamera cam(pxy,pxy, 0.5*b,0.5*a);  //perhaps better
